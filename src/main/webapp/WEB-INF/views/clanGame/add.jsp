		...
		<div class="clanAll">
			...
			<form method="post" class="vspost">
				...
				<div class="vspost_02">
					...
					<div class="vspost_02_01">
						<label>모집클랜</label> <input type="text" name="clan_recruit">
					</div>
					<div class="vspost_02_01">
					...
					<div class="vspost_02_01">
						<label>스타일</label> 
						<label><input type="radio" name="style" value="1vs1">1vs1</label>
						<label><input type="radio" name="style" value="2vs2">2vs2</label>
						<label><input type="radio" name="style" value="3vs3">3vs3</label>
						<label><input type="radio" name="style" value="4vs4">4vs4</label>
						<label><input type="radio" name="style" value="5vs5">5vs5</label>
					</div>
				</div>
