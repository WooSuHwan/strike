...
$(function() {
    ...
    <link rel="stylesheet" href="../resources/css/singupadd.css">
</head>
<body class="body">
                ...
                <div class="singup2Table">
                    <table>
                        <tbody>
                            ...
                            <tr>
                                <td class="tableColor">경도 <span>*</span></td>
                                <td class="tableInput"><input type="text" name="longitude" id="longitude" size=40></td>
