...
<form action="login" method="post">
            ...
            <div class="idpassBox">
                <div class="loginId">
                    <div class="loginIdT_01"><h3>아이디 입력</h3></div>
                    <div class="loginIdT_input">
                        <input type="text" name="id">
                    </div>
                </div>
                <div class="loginPass">
                    <div class="loginIdT_01"><h3>비밀번호 입력</h3></div>
                    <div class="loginIdT_input">
                    ...
                    <div class="membershipIn">
                        <div class="membershipIn_01">
                            <div class="membershipIn_01img">
                                <img src="../resources/img/checkbox.png" style="height: 100%; cursor: pointer;" alt="체크박스">
                            ...
                            <div class="membershipIn_01txt">
                                <a style="text-decoration: none; font-size: 0.97em;" href="javascript:doDisplay();">로그인 상태 유지</a>
                            </div>
                        </div>
                        <div class="membershipIn_02">
                            <div class="membershipIn_01img">
