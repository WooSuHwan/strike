				...
				<div class="navList">
					<div class="navListDiv">
						<div class="navListDivName">
							<a href="../mypage/update/${sessionScope.member.member_code}">내
								정보 관리</a>
						</div>
					...
					<div class="navListDiv">
						<div class="navListDivName">
							<a href="/mypage/deleteClan">클랜탈퇴</a>
						</div>
						<div class="navListDivImg">
							<img src="/resources/img/right.png" alt="">
						</div>
			...
			<div class="mypageDeletemain">
				<div class="mainBox">
					<div class="boxTitle">
						...
						<div class="titleText1">클랜 탈퇴를 진행하시겠습니까?</div>
						<div class="titleText2">
							확인 버튼을 누르시면 <br> 정상적으로 클랜탈퇴가 완료됩니다.
						</div>
					</div>
					<div class="boxButton">
