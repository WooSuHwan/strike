...
<div class="mypageNavSM"></div>
    <p style="font-size:44px;  font-weight: bold; text-align: center;" >공지사항</p>
    <div class="mypageNavSM"></div>
...
<div class="containerBox2">
    <div>
        <button class="w-btn w-btn-gray" type="button" onclick = "location.href = 'submit' " style="width:150; float: right;">글쓰기</button>
    </div>
    <div>
